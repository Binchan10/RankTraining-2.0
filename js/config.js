...
const WORDS = [
    "눈", "불", "책", "해", "강", "집", "밥", "길", "손", "꿈",
    "산", "물", "달", "발", "빵", "꽃", "돌", "봄", "별", "가람",
    "가족", "감다", "걷다", "경제", "경험", "계절", "고삐", "공원", "기린", "기술",
    "기억", "기타", "기획", "까막", "까치", "나라", "나무", "놀다", "늑대", "단비",
    "도시", "돕다", "듣다", "만세", "매듭", "먹다", "문화", "물개", "미래", "바다",
    "병원", "보다", "사람", "사자", "살다", "상점", "생각", "수달", "시간", "쓰다",
    "아라", "아람", "아침", "알다", "역사", "여우", "여울", "오리", "웃다", "울다",
    "이리", "읽다", "입술", "자다", "전체", "정보", "종교", "지게", "참새", "취미",
    "친구", "타자", "택시", "파란", "하늘", "학교", "학생", "한글", "한별", "한울",
    "행복", "헌법", "호미", "회사", "흑호", "희망", "환경", "매화", "반짝", "사랑",
    "미소", "곱다", "장미", "자유", "도약", "헌신", "강아지", "고양이", "과학자", "길노래",
    "금강송", "꽃내음", "나래움", "누리집", "다람쥐", "다리미", "달구지", "달리다", "대학교", "도서관",
    "드라마", "들국화", "마루빛", "만나다", "멧돼지", "박물관", "바다빛", "반달곰", "배우다", "부르다",
    "부장님", "별이슬", "사무실", "삼일절", "수선화", "새벽결", "서리꽃", "선생님", "소모임", "솔내음",
    "솔방울", "여행자", "연구소", "영화관", "예술가", "오락실", "우물터", "운동장", "음악가", "음식점",
    "이순신", "이야기", "인터넷", "전문가", "중학교", "즐거운", "청설모", "초롱빛", "캠핑카", "컴퓨터",
    "푸른결", "하늘소", "한가람", "한글날", "한마루", "호수빛", "휴대폰", "가랑비", "나날이", "무궁화",
    "우리말", "아리랑", "민들레", "소나기", "반듯이", "강감찬", "가르치다", "가온누리", "대기만성", "감사하다",
    "개발하다", "결정하다", "계획하다", "경험하다", "고등학교", "고려하다", "공부하다", "관찰하다", "구경하다", "기다리다",
    "기억하다", "그대에게", "나래한별", "노력하다", "도원결의", "도전정신", "도전하다", "독립운동", "들꽃내음", "무한궤도",
    "호주머니", "민주주의", "받아쓰기", "발견하다", "분석하다", "비석치기", "사자성어", "산들바람", "생각하다", "설득하다",
    "설명하다", "세종대왕", "소통하다", "수리하다", "수영하다", "실망하다", "실천하다", "아라별빛", "여행하다", "연락하다",
    "연구하다", "운동선수", "이슬별빛", "이해하다", "잎새바람", "존중하다", "준비하다", "집중하다", "참여하다", "청소하다",
    "축하하다", "타자마을", "타자연습", "통화하다", "한국문학", "해오라기", "협력하다", "눈부시다", "알아보다", "헤아리다",
    "사이좋다", "겸손하다", "일사천리", "감동시키다", "만족스럽다", "발전시키다", "고급스럽다", "무제한수련장"
];
